...
function calculateFaceCost(area, DATA) {
  ...
  return area * (pvcPrice + acrylicPrice);
}
const faceCost = calculateFaceCost(area, DATA);
//----------------------------------------------------
//Расчёт стоимости борта (Периметр, толщина, стоимость)
...
function calculatePrintCost() {
  ...
  return printSelected ? ((area * printPricePerM2) + fixedMarkup) : 0;
}
...
const workPricePerM2 = parseFloat(DATA[72][1]) || 0;
...
showDetailsBtn.addEventListener('click', () => {
  ...
  <p>Стоимость доп. покрытия и резки: ${filmCost} грн.</p>
  ...
  <p>Стоимость лица: ${faceCost} грн.</p>
  <p>Стоимость борта из ПВХ: ${sideCost} грн.</p>
...
document.getElementById('totalSum').textContent = total;
  ...
  console.log(`4. Стоимость доп.покрытия + резки: ${filmCost} грн`);
  ...
  console.log(`8. Стоимость печати: ${printCost} грн`);
  console.log(`9. Стоимость лица: ${faceCost} грн`);
  console.log(`10. Стоимость борта: ${sideCost} грн`);
