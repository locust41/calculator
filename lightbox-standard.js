...
function calculatePerimeterCost() {
  ...
  const sidePVCPrice = parseFloat(DATA[8][1]) || 0; // Цена борта (белый акрил)
...
const workPricePerM2 = parseFloat(DATA[74][1]) || 0;
...
showDetailsBtn.addEventListener('click', () => {
  ...
  <p>Стоимость борта из акрила x2: ${sideCost} грн.</p>
